...
class VehicleBorrowController(http.Controller):
    ...
    @http.route(['/automotive/automotive/vehicle/booking'], type='http', auth="user", website=True)
    ...
    @http.route(['/automotive/automotive/vehicle/booking/submit'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    ...
    @http.route(['/automotive/automotive/vehicle/my-bookings'], type='http', auth="user", website=True)
    ...
    @http.route(['/automotive/automotive/vehicle/return/<int:req_id>'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def vehicle_return(self, req_id, **post):
        ...
        return request.redirect('/automotive/automotive/vehicle/booking?msg=returned')

    @http.route(['/automotive/automotive/vehicle/cancel/<int:req_id>'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def vehicle_cancel(self, req_id, **post):
        ...
        return request.redirect('/automotive/automotive/vehicle/booking?msg=cancelled')

    @http.route(['/automotive/automotive/vehicle/report-issue/submit'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    ...
    @http.route(['/automotive/automotive/admin/vehicle/dashboard'], type='http', auth="user", website=True)
    ...
    @http.route(['/automotive/automotive/admin/member/add'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_member_add(self, **post):
        ...
        try:
            ...
            return request.redirect('/automotive/automotive/admin/vehicle/dashboard?msg=member_added")
        except Exception as e:
            return request.redirect('/automotive/automotive/admin/vehicle/dashboard?error=" + str(e))

    @http.route(['/automotive/automotive/admin/member/delete/<int:user_id>'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_member_delete(self, user_id, **post):
        if not self._is_admin():
            return request.render("http_routing.403")
        
        if user_id == request.env.user.id or user_id == 1:
            return request.redirect('/automotive/automotive/admin/vehicle/dashboard?error=ไม่สามารถลบบัญชีของตัวเองหรือ Admin หลักได้")
        
        user = request.env['res.users'].sudo().browse(user_id)
        if not user.exists():
            return request.redirect('/automotive/automotive/admin/vehicle/dashboard?error=ไม่พบผู้ใช้งานนี้ในระบบ")
        ...
        return request.redirect('/automotive/automotive/admin/vehicle/dashboard?msg=member_deleted")

    @http.route(['/automotive/automotive/admin/member/role/<int:user_id>/<string:role>'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_member_role(self, user_id, role, **post):
        ...
        try:
            ...
            return request.redirect('/automotive/automotive/admin/vehicle/dashboard?msg=role_updated")
        except Exception as e:
            return request.redirect('/automotive/automotive/admin/vehicle/dashboard?error=" + str(e))

    @http.route(['/automotive/automotive/admin/member/status/<int:user_id>/<string:status>'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_member_status(self, user_id, status, **post):
        ...
        try:
            ...
            if user.exists():
                ...
                return request.redirect('/automotive/automotive/admin/vehicle/dashboard?msg=status_updated")
        except Exception as e:
            return request.redirect('/automotive/automotive/admin/vehicle/dashboard?error=" + str(e))
        return request.redirect('/automotive/automotive/admin/vehicle/dashboard")

    @http.route(['/automotive/automotive/admin/vehicle/add'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_vehicle_add(self, **post):
        ...
        try:
            ...
            if not model_name:
                return request.redirect('/automotive/automotive/admin/vehicle/dashboard?error=Missing model name")
            ...
            return request.redirect('/automotive/automotive/admin/vehicle/dashboard?msg=vehicle_added&type=%s" % model_name)
        except Exception as e:
            import logging
            _logger = logging.getLogger(__name__)
    ...
    @http.route(['/automotive/automotive/admin/vehicle/edit'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_vehicle_edit(self, **post):
        ...
        try:
            ...
            if not vehicle.exists():
                return request.redirect('/automotive/automotive/admin/vehicle/dashboard?error=ไม่พบรถยนต์ที่ต้องการแก้ไข")
            ...
            return request.redirect('/automotive/automotive/admin/vehicle/dashboard?msg=vehicle_updated")
        except Exception as e:
            return request.redirect('/automotive/automotive/admin/vehicle/dashboard?error=" + str(e))

    @http.route(['/automotive/automotive/admin/vehicle/status/<int:vehicle_id>/<string:status>'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    ...
    @http.route(['/automotive/automotive/admin/setup/init-vehicles'], type='http', auth="user", website=True)
    def admin_init_vehicles(self, **post):
        ...
        return request.redirect('/automotive/automotive/admin/vehicle/dashboard?msg=setup_completed")
        


    @http.route(['/automotive/automotive/admin/vehicle/bookings'], type='http', auth="user", website=True)
    ...
    @http.route(['/automotive/automotive/admin/vehicle/delete/<int:vehicle_id>'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_vehicle_delete(self, vehicle_id, **post):
        ...
        try:
            ...
            if vehicle.exists():
                vehicle.sudo().unlink()
            return request.redirect('/automotive/automotive/admin/vehicle/dashboard?msg=vehicle_deleted")
        except Exception as e:
            return request.redirect('/automotive/automotive/admin/vehicle/dashboard?error=" + str(e))

    @http.route(['/automotive/automotive/admin/booking/delete/<int:req_id>'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_booking_delete(self, req_id, **post):
        ...
        try:
            ...
            if req.exists():
                req.sudo().unlink()
            return request.redirect('/automotive/automotive/admin/vehicle/bookings?msg=booking_deleted")
        except Exception as e:
            return request.redirect('/automotive/automotive/admin/vehicle/bookings?error=" + str(e))

    @http.route(['/automotive/automotive/admin/setup/list-vehicles'], type='http', auth="user", website=True)
    ...
    @http.route(['/automotive/automotive/admin/setup/delete-vehicle-by-name'], type='http', auth="user", website=True)
    ...
    @http.route(['/automotive/automotive/admin/setup/force-delete-vehicle'], type='http', auth="user", website=True)
    ...
    @http.route(['/automotive/automotive/admin/vehicle/repair'], type='http', auth="user", website=True)
    ...
    @http.route(['/automotive/automotive/admin/vehicle/repair/submit'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_repair_submit(self, **post):
        ...
        try:
            ...
            if not vehicle_id or not description:
                return request.redirect('/automotive/automotive/admin/vehicle/repair?error=กรุณาระบุรถและรายละเอียดอาการเสีย")
            ...
            return request.redirect('/automotive/automotive/admin/vehicle/repair?msg=repair_added")
        except Exception as e:
            return request.redirect('/automotive/automotive/admin/vehicle/repair?error=" + str(e))
            
    @http.route(['/automotive/automotive/admin/setup/rename-vehicles'], type='http', auth="user", website=True)
    ...
    @http.route(['/automotive/automotive/admin/setup/assign-tqs'], type='http', auth="user", website=True)
    ...
    @http.route(['/automotive/automotive/admin/vehicle/repair/done'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_repair_done(self, **post):
        ...
        return request.redirect('/automotive/automotive/admin/vehicle/repair?msg=status_updated")


    # --- SPARE PARTS FRONTEND ---

    @http.route(['/automotive/automotive/admin/spare-parts'], type='http', auth="user", website=True)
    ...
    @http.route(['/automotive/automotive/admin/spare-parts/move'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_spare_parts_move_submit(self, **post):
        ...
        try:
            ...
            return request.redirect('/automotive/automotive/admin/spare-parts?msg=move_success")
        except Exception as e:
            import logging
            logging.getLogger(__name__).error("Spare Parts Move Error: %s", str(e))
            return request.redirect('/automotive/automotive/admin/spare-parts?error=" + str(e))

    @http.route(['/automotive/automotive/admin/spare-parts/history'], type='http', auth="user", website=True)
    ...
    @http.route(['/automotive/automotive/admin/spare-parts/add'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_spare_parts_add(self, **post):
        ...
        try:
            ...
            return request.redirect('/automotive/automotive/admin/spare-parts?msg=part_added")
        except Exception as e:
            return request.redirect('/automotive/automotive/admin/spare-parts?error=" + str(e))

    @http.route(['/automotive/automotive/admin/spare-parts/edit'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_spare_parts_edit(self, **post):
        ...
        try:
            ...
            if not part.exists():
                return request.redirect('/automotive/automotive/admin/spare-parts?error=ไม่พบรายการอะไหล่")
            ...
            part.write(vals)
            return request.redirect('/automotive/automotive/admin/spare-parts?msg=part_updated")
        except Exception as e:
            return request.redirect('/automotive/automotive/admin/spare-parts?error=" + str(e))

    @http.route(['/automotive/automotive/admin/spare-parts/toggle-active/<int:part_id>'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_spare_parts_toggle_active(self, part_id, **post):
        ...
        try:
            ...
            if part.exists():
                ...
                return request.redirect('/automotive/automotive/admin/spare-parts?msg=" + msg)
            return request.redirect('/automotive/automotive/admin/spare-parts?error=ไม่พบรายการอะไหล่")
        except Exception as e:
            return request.redirect('/automotive/automotive/admin/spare-parts?error=" + str(e))

    @http.route(['/automotive/automotive/admin/spare-parts/delete/<int:part_id>'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
        ...
        try:
            ...
            if part.exists():
                ...
                if movements > 0:
                    ...
                    return request.redirect('/automotive/automotive/admin/spare-parts?msg=part_deactivated")
                
                part.unlink()
                return request.redirect('/automotive/automotive/admin/spare-parts?msg=part_deleted")
            return request.redirect('/automotive/automotive/admin/spare-parts?error=ไม่พบรายการอะไหล่")
        except Exception as e:
            return request.redirect('/automotive/automotive/admin/spare-parts?error=" + str(e))
    ...
    @http.route(['/automotive/automotive/admin/vehicle/transfer/submit'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_vehicle_transfer_submit(self, **post):
        ...
        try:
            ...
            return request.redirect('/automotive/automotive/admin/vehicle/dashboard?msg=transfer_requested')
        except Exception as e:
            return request.redirect('/automotive/automotive/admin/vehicle/dashboard?error=' + str(e))

    @http.route(['/automotive/automotive/admin/vehicle/transfer/approve/<int:req_id>'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_vehicle_transfer_approve(self, req_id, **post):
        ...
        if transfer.exists():
            ...
            return request.redirect('/automotive/automotive/admin/vehicle/dashboard?msg=transfer_approved')
        return request.redirect('/automotive/automotive/admin/vehicle/dashboard')

    @http.route(['/automotive/automotive/admin/vehicle/transfer/cancel/<int:req_id>'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_vehicle_transfer_cancel(self, req_id, **post):
        ...
        if transfer.exists():
            ...
            return request.redirect('/automotive/automotive/admin/vehicle/dashboard?msg=transfer_cancelled')
        return request.redirect('/automotive/automotive/admin/vehicle/dashboard')

    @http.route(['/automotive/automotive/admin/vehicle/transfer/accept/<int:req_id>'], type='http', auth="user", methods=['POST'], website=True, csrf=True)
    def admin_vehicle_transfer_accept(self, req_id, **post):
        ...
        if transfer.exists():
            ...
            if not self._is_head_admin() and transfer.to_factory != user_factory:
                return request.redirect('/automotive/automotive/admin/vehicle/dashboard?error=ไม่ใช่โรงงานปลายทาง')
                
            transfer.action_accept()
            return request.redirect('/automotive/automotive/admin/vehicle/dashboard?msg=transfer_accepted')
        return request.redirect('/automotive/automotive/admin/vehicle/dashboard')
