{
    ...
    'version': '2.57',                         # เวอร์ชัน 2.57: แก้ไขบั๊กการเพิ่มพนักงานใหม่/อัปเดตระดับสิทธิ์บทบาท 'user' (พนักงานทั่วไป) ให้ได้รับสิทธิ์ของทุกโรงงานเพื่อให้สามารถเข้าใช้ระบบได้ปกติ
