{
    ...
    'version': '2.63',                         # เวอร์ชัน 2.63: เพิ่มปุ่ม Export Excel สำหรับรายงานประวัติการซ่อมบำรุงรถยนต์ทั้งหมด จัดรูปแบบตารางสวยงาม สี Navy Blue และมีเส้นกริดและการสลับสีแถว (Zebra Striping)
