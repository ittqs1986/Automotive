{
    ...
    'version': '2.61',                         # เวอร์ชัน 2.61: แก้ไขการแสดงข้อมูลชื่อและรหัสผู้เข้าใช้งานระบบ (Logged-in User) ที่ส่วนท้ายของแถบเมนูนำทาง (Sidebar) ทั้งคอมพิวเตอร์และมือถือโดยดึงจาก request.env.user เพื่อความเสถียรและไม่ให้หน้าเว็บเกิดความผิดพลาด
