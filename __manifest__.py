{
    ...
    'version': '2.98',                         # เวอร์ชัน 2.98: นำเข้าฟังก์ชัน urlencode ที่ส่วนหัวของ controllers/main.py เพื่อแก้ไขข้อผิดพลาด NameError urlencode ในหน้าสต๊อกและประวัติอะไหล่
