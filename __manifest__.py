{
    ...
    'version': '2.90',                         # เวอร์ชัน 2.90: ปรับแต่งปุ่มเปลี่ยนหน้า (Pagination) โดยนำตัวหนังสือ ก่อนหน้า/ถัดไป ออก ให้เหลือเพียงไอคอนลูกศรเพื่อความสวยงามและป้องกันการซ้อนทับกันของตัวอักษร
