{
    ...
    'version': '2.62',                         # เวอร์ชัน 2.62: เพิ่มปุ่ม Export Excel สำหรับรายงานรายการอะไหล่คงเหลือและประวัติการเคลื่อนไหวของอะไหล่ จัดรูปแบบรายงานสวยงาม มีเส้นกริดและการสลับสีแถว (Zebra Striping)
